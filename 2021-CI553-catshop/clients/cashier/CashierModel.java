...
public class CashierModel extends Observable
{
  ...
  public void doBought()
  {
    String theAction = "";
    int    amount  = 1;                       //  & quantity
    soundPlayer.playSound("ca_ching");
    try
    {
      if ( theBasket != null &&
...
//	  if the basket is not empty run the for loop else show nothing in the basket
//	  Add sound to the system
	  soundPlayer.playSound("sound_4");
	  if(theBasket != null) {
	  for(int i = 0; i < theBasket.size(); i ++) {
		  ...
		  DEBUG.error("CashierModel", "Empty basket");
	  }
  }
